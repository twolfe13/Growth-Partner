...
export default function Aboutme() {
  ...
  return (
    <div>
      ...
      <div className="flex flex-col md:flex-row  w-full px-10 justify-between py-[125px] gap-10 md:px-[100px]">
        ...
        <div className="flex flex-col gap-2 justify-center md:justify-end w-full md:w-1/3 h-96 md:h-24 items-center">
